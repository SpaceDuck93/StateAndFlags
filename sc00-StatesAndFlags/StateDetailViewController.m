...
- (void)viewDidLoad {
    ...
    }else if ([_myState.name isEqualToString:@"New York"]){
        self.area.text = @"Area: 304.6 mi²";
        self.statePopulation.text = @"Population: 20 Millions";
    }else if ([_myState.name isEqualToString:@"Alaska"]){
        self.area.text = @"Area: 663,300 mi²";
        self.statePopulation.text = @"Population: 736 Thousand";
    }else if ([_myState.name isEqualToString:@"Massachusetts"]){
        self.area.text = @"Area: 10,554 mi²";
        self.statePopulation.text = @"Population: 7 million";
    }else if ([_myState.name isEqualToString:@"Arizona"]){
        self.area.text = @"Area: 113,998 mi²";
        self.statePopulation.text = @"Population: 7 million";
    }
